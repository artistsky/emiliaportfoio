...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-8a4dd7b9414dd9c95d7f.js"
  },
  {
    "url": "app-c683bc596e51f8c9c83b.js"
  },
  {
    "url": "component---node-modules-gatsby-plugin-offline-app-shell-js-3c480bd456154b6e00a1.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "f828828b598a0aeed0abb7927e48ca0b"
  },
  {
  ...
  },
  {
    ...
    "revision": "9b879c15f9221910b4408f670922c9f9"
  }
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/gatsby-starter-portfolio-emilia/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/gatsby-starter-portfolio-emilia" + pathname;
      } else {
        return pathname;
      }
    });
